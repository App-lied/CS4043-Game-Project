...
function scene:create( event )
   ...
   local background = display.newImageRect( sceneGroup, "thumbnail.png", 1280*2, 720*2)
    ...
    local menuButton = display.newText( sceneGroup, "Menu", display.contentCenterX-10, 1000, "Helvetica", 52 )
    menuButton:setFillColor( 1, 1, 0 )
    menuButton:addEventListener( "tap", gotoMenu )

    local rect2 = display.newRoundedRect( sceneGroup, display.contentCenterX-10, 1000, 250, 100, 15 )
