...
function M.new()
	...
	local vending1 = vendingData.new({name = "famas"}, {name = "vendingMachine1",x = 3500, y = 600, width = 300, height = 500})

	local vending2 = vendingData.new({name = "python"}, {name = "vendingMachine1",x = 3800, y = 1300, width = 300, height = 500})

	local vending3 = vendingData.new({name = "uzi"}, {name = "vendingMachine1",x = 2800, y = 1300, width = 300, height = 500}) 

	local vending4 = vendingData.new({name = "mac11"}, {name = "vendingMachine1",x = 3800, y = 1980, width = 270, height = 450})
	
	local vending5 = vendingData.new({name = "mossberg"}, {name = "vendingMachine1",x = 4350, y = 2650, width = 300, height = 500})
	
	local vending6 = vendingData.new({name = "glock"}, {name = "vendingMachine1",x = 650, y = 2600, width = 300, height = 500})
	
	local vending7 = vendingData.new({name = "ak47"}, {name = "vendingMachine1",x = 300, y = 3500, width = 300, height = 500})
	...
	table.insert(map, vending5)
	table.insert(map, vending6)
	table.insert(map, vending7)
