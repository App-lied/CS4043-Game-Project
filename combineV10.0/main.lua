...
--Objects
local vending1 = display.newImageRect(backGroup,"vending machine 1.png", 300,400)
vending1.x = 300
vending1.y = 720
...
player.isFixedRotation = true
	...
	local ak472Text = display.newText("[F] ak47", vending1.x, vending1.y - 200, native.systemFont, 50 )
...
local function text2()
	ak472Text.x = vending1.x
	--ak472Text.y = vending1.y - 200
end

--physics.addBody(vending1, "kinematic", {bounce = 0.0},{isSensor = false})
...
local function frameUpdate()
	...
	vending1.x = vending1.x + vending1.deltaPerFrame[1]
	vending1.y = vending1.y + vending1.deltaPerFrame[2]
...
local function gameLoopRandPickup()
		if randomAK47 == true then
			if  (player.x > vending1.x - 150) and (player.x < vending.x + 150) and (player.y > vending1.y - 200) and (player.y < vending1.y + 200) then
				ak472Text.isVisible = true
			elseif  (player.x < vending1.x - 150) and (player.x > vending1.x + 150) and (player.y < vending1.y - 200) and (player.y > vending1.y + 200) then
				ak472Text.isVisible = false
			end
		elseif randomUzi == true then
...
gameLoopTimer = timer.performWithDelay(17, text2, 0)
