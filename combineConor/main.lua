...
player = display.newImageRect(mainGroup, "square.png", 25, 25)
...
block = display.newImageRect("platform.png", math.random(25, 300), math.random(30, 300))
block.x = math.random(-300, 500)
block.y = math.random(0, 500)
block:rotate(math.random(0, 360))

block2 = display.newImageRect("platform.png", math.random(25, 300), math.random(30, 300))
block2.x = math.random(-300, 500)
block2.y = math.random(0, 500)
--block2:rotate(math.random(0, 360))

block3 = display.newImageRect("platform.png", math.random(25, 300), math.random(30, 300))
block3.x = math.random(-300, 500)
block3.y = math.random(0, 500)
--block3:rotate(math.random(0, 360))

block4 = display.newImageRect("platform.png", math.random(25, 100), math.random(30, 300))
block4.x = math.random(-300, 500)
block4.y = math.random(0, 500)
--block4:rotate(math.random(0, 360))

block5 = display.newImageRect("platform.png", math.random(25, 100), math.random(30, 300))
block5.x = math.random(-300, 500)
block5.y = math.random(0, 500)
--block5:rotate(math.random(0, 360))

block6 = display.newImageRect("platform.png", math.random(25, 100), math.random(30, 300))
block6.x = math.random(-300, 500)
block6.y = math.random(0, 500)
--block6:rotate(math.random(0, 360))
...
physics.addBody(block, "static", {bounce = 0.0})
physics.addBody(block2, "static", {bounce = 0.0})
physics.addBody(block3, "static", {bounce = 0.0})
physics.addBody(block4, "static", {bounce = 0.0})
physics.addBody(block5, "static", {bounce = 0.0})
physics.addBody(block6, "static", {bounce = 0.0})
...
function fireLaser()
	...
	if leftClickIsPressed then
		...
		--[[	else if (currentGun == mossberg) then
				transition.to( newLaser, {x=x2, y=y2, time=length*2,
					onComplete = function()display.remove(newLaser)end
				})
				transition.to( newLaser, {x=x2, y=y2, time=length*2,
...
local function onHookCollision(event)
	local degrees = math.deg(math.atan(math.abs(reticle.y-player.y)/math.abs(reticle.x-player.x)))
	local i = 0.1*(math.cos(degrees))
	local j = 0.1*(math.sin(degrees))
	print(degrees.." "..i.." "..j)
	if (not (event.other == player)) then
		player:applyLinearImpulse(i, j, player.x, player.y)
	end
end
...
local function onCollision(event)
	if (event.phase == "began") then
		...
		or (obj1.myName == "zombie" and obj2.myName == "laser")
		 ...
		 if
			  ((obj1.myName == "laser" and obj2.myName == "block") or
				(obj1.myName == "laser" and obj2.myName == "block2") or
				(obj1.myName == "laser" and obj2.myName == "block3") or
				(obj1.myName == "laser" and obj2.myName == "block4") or
				(obj1.myName == "laser" and obj2.myName == "block5") or
				(obj1.myName == "laser" and obj2.myName == "block6") or
				(obj1.myName == "laser" and obj2.myName == "ceiling") or
				(obj1.myName == "laser" and obj2.myName == "platform")) then
					 display.remove(obj1)

		 if
				((obj1.myName == "block" and obj2.myName == "laser") or
		 		(obj1.myName == "block2" and obj2.myName == "laser") or
		 		(obj1.myName == "block3" and obj2.myName == "laser") or
		 		(obj1.myName == "block4" and obj2.myName == "laser") or
		 		(obj1.myName == "block5" and obj2.myName == "laser") or
		 		(obj1.myName == "block6" and obj2.myName == "laser") or
		 		(obj1.myName == "ceiling" and obj2.myName == "laser") or
		 		(obj1.myName == "platform" and obj2.myName == "laser")) then
					display.remove(obj2)
				end
			end
			score = score + 100
...
function StopRotation()
		player:rotate(360-player.rotation)
		timer.performWithDelay( 0, StopRotation2 )
end

function StopRotation2()
		timer.performWithDelay( 0, StopRotation )
end
...
gameLoopTimer = timer.performWithDelay(20000, spawnZombie, 0)
gameLoopTimer = timer.performWithDelay( 0, StopRotation)
